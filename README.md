...
Сайт утилиты - https://clearbat.iiko.online/

Так же читайте Wiki:

https://clearbat.iiko.online/ (новая)

https://github.com/ru2mix/CLEAR.bat/wiki (Старая)
...
EXE >>>  v 5.5 Stable - [CLEAR.bat_V5.exe](https://github.com/ru2mix/CLEAR.bat/raw/main/CLEAR.bat_V5.exe) (Умеет все! Будет обновляться весит 3мб. Нужен .Net 4.5.2)

EXE >>> v6 - [CLEAR.bat.exe](https://clearbat.iiko.online/downloads/CLEAR.bat.exe) (Обновленная и улучшенная версия)
...
Ваши предложения и улучшения жду в личку (Роберт Лато), в телегу ( https://t.me/rlato )
