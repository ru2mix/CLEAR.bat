...
BAT >>> v 2.20 Stable - clear_v2.20.bat (Не умеет скачивать плагины, только очистка, последняя стабильная версия в bat формате, для любителей мелких файлов всего 16кб)

EXE >>>  v 5.2 Stable - CLEAR.bat.exe (Умеет все! Будет обновляться весит 10мб (По сути не так уж и много) Нужен .Net 4.5.2
...
Суть работы: 
-Нажимаете настроить: Выбираете путь до беков.
-Вбиваете сервер iiko в строку, далее если нужно вбиваете порт, и нажимаете запустить iiko. Бек нужной версии запуститься.
-Бек будет уже с введенным адресом, осталось только ввесли толгин и пароль.
-Установка лицензий. Без захода в бек спрятана в меню Справка
