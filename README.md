...
Сайт утилиты - https://clearbat.ru/

Так же читайте Wiki:

https://wiki.clearbat.ru/ (новая)
...
EXE >>> v6 - [CLEAR.bat.exe](https://github.com/ru2mix/CLEAR.bat/raw/main/CLEAR.bat.exe) (Обновленная и улучшенная версия)
